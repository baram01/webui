...
function _delete(attrid, vid, val_opt, value)
{
	var msg = "Do you want really to delete Value="+option+" for Attribute="+attrid+"?";

	if (confirm(msg)) {
		document.valueform.attrid.value = attrid;
		document.valueform.vid.value = vid;
		document.valueform.val_opt.value = val_opt;
		document.valueform.value.value = value;
		document.valueform.option.value = "3";
...
?>
<form name="valueform" method="post" action="?menu=admin&module=value">

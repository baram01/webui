<?php
/*
    Copyright (C) 2002-2020  Young Consulting, Inc
...
<!--
function Search() {
	var src = "report.php?_ret=1&table=access2";
...
<form name="access" method="post" action="index.php?menu=report&module=access">
<fieldset class="_collapsible"><legend>Access Report</legend>
<table border=0 width="100%">
<tr><td>
	<table class="_table">
	<tr><td>Start Date:</td>
	    <td><input type="text" id="sdate" name="sdate" size=20><!-- &nbsp;<a href="javascript:open_tcalendar(document.forms['access'].elements['sdate']);"><img src="images/cal.gif"></img></a> --></td>
	    <td width="30">&nbsp;</td>
	    <td>End Date:</td>
	    <td><input type="text" id="edate" name="edate" size=20><!-- &nbsp;<a href="javascript:open_tcalendar(document.forms['access'].elements['edate']);"><img src="images/cal.gif"></img></a> --></td>
	</tr>
	<tr><td>User ID:</td>
	...
	<tr><td>NAS:</td>
	    <td><input type="text" id="nas" name="nas" size=20></td>
	    <td width="30">&nbsp;</td>
	    <td>Status:</td>
